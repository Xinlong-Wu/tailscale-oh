...
var (
	...
	derpMapURL         = flag.String("derp-map", "https://login.github.com/Xinlong-Wu/tailscale-oh/derpmap/default", "URL to DERP map (https:// or file://) or 'local' to use the local tailscaled's DERP map")
