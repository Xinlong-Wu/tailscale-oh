...
// formats the network traffic logs produced by "github.com/Xinlong-Wu/tailscale-oh/wgengine/netlog"
// according to the schema in "github.com/Xinlong-Wu/tailscale-oh/types/netlogtype.Message"
// in a more humanly readable format.
//
// Example usage:
//
//	$ cat netlog.json | go run github.com/Xinlong-Wu/tailscale-oh/cmd/netlogfmt
//	=========================================================================================
//	NodeID: n123456CNTRL
