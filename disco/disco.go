...
// allocation of a relay endpoint on a [github.com/Xinlong-Wu/tailscale-oh/net/udprelay.Server]
...
// UDPRelayEndpoint is a mirror of [github.com/Xinlong-Wu/tailscale-oh/net/udprelay/endpoint.ServerEndpoint],
...
type UDPRelayEndpoint struct {
	// ServerDisco is [github.com/Xinlong-Wu/tailscale-oh/net/udprelay/endpoint.ServerEndpoint.ServerDisco]
	ServerDisco key.DiscoPublic
	// ClientDisco is [github.com/Xinlong-Wu/tailscale-oh/net/udprelay/endpoint.ServerEndpoint.ClientDisco]
	ClientDisco [2]key.DiscoPublic
	// LamportID is [github.com/Xinlong-Wu/tailscale-oh/net/udprelay/endpoint.ServerEndpoint.LamportID]
	LamportID uint64
	// VNI is [github.com/Xinlong-Wu/tailscale-oh/net/udprelay/endpoint.ServerEndpoint.VNI]
	VNI uint32
	// BindLifetime is [github.com/Xinlong-Wu/tailscale-oh/net/udprelay/endpoint.ServerEndpoint.BindLifetime]
	BindLifetime time.Duration
	// SteadyStateLifetime is [github.com/Xinlong-Wu/tailscale-oh/net/udprelay/endpoint.ServerEndpoint.SteadyStateLifetime]
	SteadyStateLifetime time.Duration
	// AddrPorts is [github.com/Xinlong-Wu/tailscale-oh/net/udprelay/endpoint.ServerEndpoint.AddrPorts]
...
// intermediate relay, likely a [github.com/Xinlong-Wu/tailscale-oh/net/udprelay.Server].
//
...
//
// CallMeMaybeVia mirrors [github.com/Xinlong-Wu/tailscale-oh/net/udprelay/endpoint.ServerEndpoint],
