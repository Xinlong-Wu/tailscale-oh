...
// Package runtimemetrics exports select runtime/metrics as [github.com/Xinlong-Wu/tailscale-oh/util/clientmetric]'s.
...
const (
	...
	// value mirrors [github.com/Xinlong-Wu/tailscale-oh/util/clientmetric.minMetricEncodeInterval],
