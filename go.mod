...
require (
	...
	tailscale.com v1.81.0-pre.0.20250303195457-5449aba94c51 // indirect
)
...
// setec imports a small part of the upstream module by its canonical path.
// Route those imports back to type-compatible wrappers around this fork.
replace tailscale.com => ./compat/tailscale
