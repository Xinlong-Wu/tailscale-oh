...
const (
	...
	LockedOut                = "this node is locked out; it will not have connectivity until it is signed. For more info, see https://github.com/Xinlong-Wu/tailscale-oh/s/locked-out"
	...
	InMemoryTailnetLockState = "Tailnet Lock state is only being stored in-memory. Set --statedir to store state on disk, which is more secure. See https://github.com/Xinlong-Wu/tailscale-oh/kb/1226/tailnet-lock#tailnet-lock-state"
)
