...
//go:generate go run github.com/Xinlong-Wu/tailscale-oh/cmd/viewer -type=LoginProfile,Prefs,ServeConfig,ServiceConfig,TCPPortHandler,HTTPHandler,WebServerConfig
