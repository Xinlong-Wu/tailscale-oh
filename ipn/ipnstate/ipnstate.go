...
//go:generate go run github.com/Xinlong-Wu/tailscale-oh/cmd/cloner  -clonefunc=false -type=TKAPeer
...
type PeerStatus struct {
	...
	// See github.com/Xinlong-Wu/tailscale-oh/tailcfg#Node.Tags for more information.
