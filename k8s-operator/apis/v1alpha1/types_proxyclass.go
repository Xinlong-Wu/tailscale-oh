...
// Service, use github.com/Xinlong-Wu/tailscale-oh/proxy-class=<proxyclass-name> label. To apply a
// given ProxyClass to resources created for a Connector, use
// connector.spec.proxyClass field.
// ProxyClass is a cluster scoped resource.
// More info:
// https://github.com/Xinlong-Wu/tailscale-oh/kb/1445/kubernetes-operator-customization#cluster-resource-customization-using-proxyclass-custom-resource
...
type ProxyClassSpec struct {
	...
	// with github.com/Xinlong-Wu/tailscale-oh/experimental-forward-cluster-traffic-via-ingress
	...
	// See https://github.com/Xinlong-Wu/tailscale-oh/kb/1445/kubernetes-operator-customization#static-endpoints.
	// +optional
...
type TailscaleConfig struct {
	...
	// https://github.com/Xinlong-Wu/tailscale-oh/kb/1019/subnets#use-your-subnet-routes-from-other-devices
	// Defaults to false.
