...
//
// For ingress and egress, use the github.com/Xinlong-Wu/tailscale-oh/proxy-group annotation on a
// Service to specify that the proxy should be implemented by a ProxyGroup
// instead of a single dedicated proxy.
//
// More info:
// * https://github.com/Xinlong-Wu/tailscale-oh/kb/1438/kubernetes-operator-cluster-egress
// * https://github.com/Xinlong-Wu/tailscale-oh/kb/1439/kubernetes-operator-cluster-ingress
//
