...
type KubernetesCapRule struct {
	...
	// https://github.com/Xinlong-Wu/tailscale-oh/kb/1246/tailscale-ssh-session-recording#turn-on-session-recording-in-acls
	...
	// session recorder.
	// https://github.com/Xinlong-Wu/tailscale-oh/kb/1246/tailscale-ssh-session-recording#turn-on-session-recording-in-your-tailnet-policy-file
