...
//go:generate go run github.com/Xinlong-Wu/tailscale-oh/cmd/addlicense -file pcpresultcode_string.go go run golang.org/x/tools/cmd/stringer -type=pcpResultCode -trimprefix=pcpCode
