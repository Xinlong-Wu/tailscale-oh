...
// does not import github.com/Xinlong-Wu/tailscale-oh/net/udprelay.
package endpoint
...
// [github.com/Xinlong-Wu/tailscale-oh/net/udprelay.ErrServerNotReady.RetryAfter] value.
const ServerRetryAfter = time.Second * 3

// ServerEndpoint contains details for an endpoint served by a
// [github.com/Xinlong-Wu/tailscale-oh/net/udprelay.Server].
