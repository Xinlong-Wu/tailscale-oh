...
func autoflagsForTest(argv []string, env *Environment, goroot, nativeGOOS, nativeGOARCH string, getVersion func() mkversion.VersionInfo) (newArgv []string, newEnv *Environment, err error) {
	...
	vi := getVersion()
	ldflags = []string{
		"-X", "github.com/Xinlong-Wu/tailscale-oh/version.longStamp=" + vi.Long,
		"-X", "github.com/Xinlong-Wu/tailscale-oh/version.shortStamp=" + vi.Short,
		"-X", "github.com/Xinlong-Wu/tailscale-oh/version.gitCommitStamp=" + vi.GitHash,
		"-X", "github.com/Xinlong-Wu/tailscale-oh/version.extraGitCommitStamp=" + vi.OtherHash,
	}
