...
func TestDeps(t *testing.T) {
	deptest.DepChecker{
		...
		BadDeps: map[string]string{
			...
			"github.com/Xinlong-Wu/tailscale-oh/chirp":                 "tsnet should not depend on BIRD integration",
			"github.com/Xinlong-Wu/tailscale-oh/feature/bird":          "tsnet should not depend on BIRD integration",
			"github.com/Xinlong-Wu/tailscale-oh/feature/captiveportal": "tsnet apps don't need captive portal detection; import it explicitly if desired",
			"github.com/Xinlong-Wu/tailscale-oh/feature/clientupdate":  "tsnet should not depend on feature/clientupdate",
			"github.com/Xinlong-Wu/tailscale-oh/feature/remoteconfig":  "tsnet should not depend on feature/remoteconfig",
			"github.com/Xinlong-Wu/tailscale-oh/feature/syspolicy":     "tsnet should not depend on syspolicy",
			...
			"github.com/Xinlong-Wu/tailscale-oh/wif":                   "tsnet callers wanting workload identity federation should import github.com/Xinlong-Wu/tailscale-oh/feature/identityfederation themselves",
		},
