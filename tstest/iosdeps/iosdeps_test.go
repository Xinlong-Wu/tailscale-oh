...
func TestDeps(t *testing.T) {
	deptest.DepChecker{
		...
		BadDeps: map[string]string{
			...
			"github.com/Xinlong-Wu/tailscale-oh/net/wsconn":            "https://github.com/tailscale/tailscale/issues/13762",
			...
			"github.com/Xinlong-Wu/tailscale-oh/clientupdate/distsign": "downloads via AppStore, not distsign",
			"github.com/tailscale/hujson":         "no config file support on iOS",
			"github.com/Xinlong-Wu/tailscale-oh/feature/capture":       "no debug packet capture on iOS",
		},
	}.Check(t)
}
