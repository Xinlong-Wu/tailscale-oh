...
//
// The preference types are compatible with the [github.com/Xinlong-Wu/tailscale-oh/cmd/viewer] and
// [github.com/Xinlong-Wu/tailscale-oh/cmd/cloner] utilities. It is recommended to generate a read-only view
