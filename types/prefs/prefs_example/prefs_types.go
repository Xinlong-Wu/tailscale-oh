...
// Package prefs_example contains a [Prefs] type, which is like [github.com/Xinlong-Wu/tailscale-oh/ipn.Prefs],
...
// and due to limitations in [github.com/Xinlong-Wu/tailscale-oh/cmd/viewer] when
...
// Prefs is like [github.com/Xinlong-Wu/tailscale-oh/ipn.Prefs], but with individual preferences wrapped in
...
//
// Just like [github.com/Xinlong-Wu/tailscale-oh/ipn.Prefs], [Prefs] is a mutable struct. It should
