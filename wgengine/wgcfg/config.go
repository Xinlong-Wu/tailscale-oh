...
//go:generate go run github.com/Xinlong-Wu/tailscale-oh/cmd/cloner -type=Config
...
// installed via [github.com/Xinlong-Wu/tailscale-oh/wgengine.Engine.SetPeerConfigFunc].
type Config struct {
